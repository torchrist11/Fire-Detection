...
public class extract {
	String file = Control.file2;
	File pathFile;
	private static String[] alamat = new String[] { "(DACE)", "(AAAF)", "(AADC)", "(CACF)", "(BCAF)", "(DACE)" };
	private static double[] node1T = new double[100]; private static double[] node1H = new double[100]; private static double[] node1P = new double[100];
	private static double[] node2T = new double[100]; private static double[] node2H = new double[100]; private static double[] node2P = new double[100];
	private static double[] node3T = new double[100]; private static double[] node3H = new double[100]; private static double[] node3P = new double[100];
	private static double[] node4T = new double[100]; private static double[] node4H = new double[100]; private static double[] node4P = new double[100];
	private static double[] node5T = new double[100]; private static double[] node5H = new double[100]; private static double[] node5P = new double[100];
	private static double[] node6T = new double[100]; private static double[] node6H = new double[100]; private static double[] node6P = new double[100];
	...
	private static void fiturextract() throws Exception {
		...
		try {
			...
			BufferedReader read = new BufferedReader(new FileReader("C:\\Users\\torch\\eclipse-workspace\\Prog\\Hasil Sense\\file.txt"));
